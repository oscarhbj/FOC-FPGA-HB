...
#
# FOC-FPGA-HB.tcl: Tcl script for re-creating project 'FOC-FPGA-HB'
#
# Generated by Vivado on Fri Jun 28 12:03:20 CEST 2024
...
#
# 1. This project restoration tcl script (FOC-FPGA-HB.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "RTL/src/config.vhd"
#    "RTL/src/control_module.vhd"
#    "RTL/src/clarke_transform.vhd"
#    "RTL/src/park_transform.vhd"
#    "RTL/src/pi.vhd"
#    "RTL/src/inv_park_transform.vhd"
#    "RTL/src/cordic_angle_abs.vhd"
#    "RTL/src/svpwm.vhd"
#    "RTL/src/sin_lut.vhd"
#    "FOC-FPGA-HB/RTL/src/sin_60_lut.vhd"
#    "FOC-FPGA-HB/RTL/src/top.vhd"
#    "FOC-FPGA-HB/RTL/src/encoder.vhd"
#    "FOC-FPGA-HB/RTL/src/spi_v3.vhd"
#    "FOC-FPGA-HB/RTL/src/top_fpga_trenz.vhd"
#    "FOC-FPGA-HB/RTL/xdc/master_xdc_trenz_mn.xdc"
#    "FOC-FPGA-HB/RTL/src/sin_lut_bin.txt"
#    "FOC-FPGA-HB/RTL/src/sin_lut_harmonic.txt"
#    "FOC-FPGA-HB/RTL/src/tan_lut_bin.txt"
#
...
proc checkRequiredFiles { origin_dir} {
  ...
  set files [list \
   "RTL/src/config.vhd" \
   "${origin_dir}/RTL/src/control_module.vhd" \
   "${origin_dir}/RTL/src/clarke_transform.vhd" \
   "${origin_dir}/RTL/src/park_transform.vhd" \
   "${origin_dir}/RTL/src/pi.vhd" \
   "${origin_dir}/RTL/src/inv_park_transform.vhd" \
   "${origin_dir}/RTL/src/cordic_angle_abs.vhd" \
   "${origin_dir}/RTL/src/svpwm.vhd" \
   "${origin_dir}/RTL/src/sin_lut.vhd" \
   "${origin_dir}/RTL/src/sin_60_lut.vhd" \
   "${origin_dir}/RTL/src/top.vhd" \
   "${origin_dir}/RTL/src/encoder.vhd" \
   "${origin_dir}/RTL/src/spi_v3.vhd" \
   "${origin_dir}/RTL/src/top_fpga_trenz.vhd" \
   "${origin_dir}/RTL/xdc/master_xdc_trenz_mn.xdc" \
   "${origin_dir}/RTL/src/sin_lut_bin.txt" \
   "${origin_dir}/RTL/src/sin_lut_harmonic.txt" \
   "${origin_dir}/RTL/src/tan_lut_bin.txt" \
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "FOC-FPGA-HB"
...
set script_file "FOC-FPGA-HB.tcl"
...
set files [list \
 [file normalize "${origin_dir}/RTL/src/config.vhd" ]\
 [file normalize "${origin_dir}/RTL/src/control_module.vhd" ]\
 [file normalize "${origin_dir}/RTL/src/clarke_transform.vhd" ]\
 [file normalize "${origin_dir}/RTL/src/park_transform.vhd" ]\
 [file normalize "${origin_dir}/RTL/src/pi.vhd" ]\
 [file normalize "${origin_dir}/RTL/src/inv_park_transform.vhd" ]\
 [file normalize "${origin_dir}/RTL/src/cordic_angle_abs.vhd" ]\
 [file normalize "${origin_dir}/RTL/src/svpwm.vhd" ]\
 [file normalize "${origin_dir}/RTL/src/sin_lut.vhd" ]\
 [file normalize "${origin_dir}/RTL/src/sin_60_lut.vhd" ]\
 [file normalize "${origin_dir}/RTL/src/top.vhd" ]\
 [file normalize "${origin_dir}/RTL/src/encoder.vhd" ]\
 [file normalize "${origin_dir}/RTL/src/spi_v3.vhd" ]\
 [file normalize "${origin_dir}/RTL/src/top_fpga_trenz.vhd" ]\
]
...
set file "src/control_module.vhd"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
set file "src/clarke_transform.vhd"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL 2008" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
...
set file "src/park_transform.vhd"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL 2008" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
...
set file "src/inv_park_transform.vhd"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL 2008" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
...
set file "src/cordic_angle_abs.vhd"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL 2008" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
...
set file "src/top_fpga_trenz.vhd"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
...
set file "[file normalize "$origin_dir/RTL/xdc/master_xdc_trenz_mn.xdc"]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "xdc/master_xdc_trenz_mn.xdc"
...
set_property -name "top" -value "top_fpga_trenz" -objects $obj
set_property -name "top_arch" -value "TOP" -objects $obj
set_property -name "top_file" -value "$proj_dir/FOC-FPGA-HB/RTL/src/top_fpga_trenz.vhd" -objects $obj
...
if { [get_files config.vhd] == "" } {
  import_files -quiet -fileset sources_1 RTL/src/config.vhd
}
if { [get_files control_module.vhd] == "" } {
  import_files -quiet -fileset sources_1 RTL/src/control_module.vhd
}
if { [get_files clarke_transform.vhd] == "" } {
  import_files -quiet -fileset sources_1 RTL/src/clarke_transform.vhd
}
if { [get_files park_transform.vhd] == "" } {
  import_files -quiet -fileset sources_1 RTL/src/park_transform.vhd
}
if { [get_files pi.vhd] == "" } {
  import_files -quiet -fileset sources_1 RTL/src/pi.vhd
}
if { [get_files inv_park_transform.vhd] == "" } {
  import_files -quiet -fileset sources_1 RTL/src/inv_park_transform.vhd
}
if { [get_files cordic_angle_abs.vhd] == "" } {
  import_files -quiet -fileset sources_1 RTL/src/cordic_angle_abs.vhd
}
if { [get_files svpwm.vhd] == "" } {
  import_files -quiet -fileset sources_1 RTL/src/svpwm.vhd
}
if { [get_files sin_lut.vhd] == "" } {
  import_files -quiet -fileset sources_1 RTL/src/sin_lut.vhd
}
if { [get_files sin_60_lut.vhd] == "" } {
  import_files -quiet -fileset sources_1 RTL/src/sin_60_lut.vhd
}
if { [get_files top.vhd] == "" } {
  import_files -quiet -fileset sources_1 RTL/src/top.vhd
}
if { [get_files encoder.vhd] == "" } {
  import_files -quiet -fileset sources_1 RTL/src/encoder.vhd
}
if { [get_files spi_v3.vhd] == "" } {
  import_files -quiet -fileset sources_1 RTL/src/spi_v3.vhd
}
if { [get_files top_fpga_trenz.vhd] == "" } {
  import_files -quiet -fileset sources_1 RTL/src/top_fpga_trenz.vhd
}
...
# top_fpga_trenz
  ...
  # Create ports
  set CHA [ create_bd_port -dir I -from 1 -to 0 CHA ]
  set CHB [ create_bd_port -dir I -from 1 -to 0 CHB ]
  set CHI [ create_bd_port -dir I -from 1 -to 0 CHI ]
  set CS [ create_bd_port -dir O -from 0 -to 0 CS ]
  set MISO [ create_bd_port -dir I -from 0 -to 0 MISO ]
  set MOSI [ create_bd_port -dir O -from 0 -to 0 MOSI ]
  set SPI_clk [ create_bd_port -dir O -from 0 -to 0 -type clk SPI_clk ]
  set en_gate [ create_bd_port -dir O -from 1 -to 0 en_gate ]
  set pwm_motor0 [ create_bd_port -dir O -from 5 -to 0 pwm_motor0 ]
  set pwm_motor1 [ create_bd_port -dir O -from 5 -to 0 pwm_motor1 ]
  ...
  # Create instance: top_fpga_trenz_0, and set properties
  set block_name top_fpga_trenz
  set block_cell_name top_fpga_trenz_0
  if { [catch {set top_fpga_trenz_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $top_fpga_trenz_0 eq "" } {
  ...
  connect_bd_net -net CHA_0_1 [get_bd_ports CHA] [get_bd_pins top_fpga_trenz_0/CHA]
  connect_bd_net -net CHB_0_1 [get_bd_ports CHB] [get_bd_pins top_fpga_trenz_0/CHB]
  connect_bd_net -net CHI_0_1 [get_bd_ports CHI] [get_bd_pins top_fpga_trenz_0/CHI]
  connect_bd_net -net MISO_0_1 [get_bd_ports MISO] [get_bd_pins top_fpga_trenz_0/MISO]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_pins top_fpga_trenz_0/iq_ref0]
  connect_bd_net -net axi_gpio_1_gpio2_io_o [get_bd_pins axi_gpio_1/gpio2_io_o] [get_bd_pins top_fpga_trenz_0/amp_override]
  connect_bd_net -net axi_gpio_1_gpio_io_o [get_bd_pins axi_gpio_1/gpio_io_o] [get_bd_pins top_fpga_trenz_0/angle_override]
  connect_bd_net -net axi_gpio_2_gpio2_io_o [get_bd_pins axi_gpio_2/gpio2_io_o] [get_bd_pins top_fpga_trenz_0/KI_q]
  connect_bd_net -net axi_gpio_2_gpio_io_o [get_bd_pins axi_gpio_2/gpio_io_o] [get_bd_pins top_fpga_trenz_0/KP_q]
  connect_bd_net -net axi_gpio_3_gpio2_io_o [get_bd_pins axi_gpio_3/gpio2_io_o] [get_bd_pins top_fpga_trenz_0/KI_d]
  connect_bd_net -net axi_gpio_3_gpio_io_o [get_bd_pins axi_gpio_3/gpio_io_o] [get_bd_pins top_fpga_trenz_0/KP_d]
  connect_bd_net -net axi_gpio_6_gpio_io_o [get_bd_pins axi_gpio_6/gpio_io_o] [get_bd_pins top_fpga_trenz_0/iq_ref1]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_gpio_2/s_axi_aclk] [get_bd_pins axi_gpio_3/s_axi_aclk] [get_bd_pins axi_gpio_4/s_axi_aclk] [get_bd_pins axi_gpio_5/s_axi_aclk] [get_bd_pins axi_gpio_6/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins ps7_0_axi_periph/M05_ACLK] [get_bd_pins ps7_0_axi_periph/M06_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins top_fpga_trenz_0/clk_main]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_0_1 [get_bd_ports rst] [get_bd_pins top_fpga_trenz_0/rst]
  ...
  connect_bd_net -net top_fpga_trenz_0_CS [get_bd_ports CS] [get_bd_pins top_fpga_trenz_0/CS]
  connect_bd_net -net top_fpga_trenz_0_MOSI [get_bd_ports MOSI] [get_bd_pins top_fpga_trenz_0/MOSI]
  connect_bd_net -net top_fpga_trenz_0_SPI_clk [get_bd_ports SPI_clk] [get_bd_pins top_fpga_trenz_0/SPI_clk]
  connect_bd_net -net top_fpga_trenz_0_angle_out [get_bd_pins axi_gpio_4/gpio2_io_i] [get_bd_pins top_fpga_trenz_0/angle_out]
  connect_bd_net -net top_fpga_trenz_0_current_ia [get_bd_pins axi_gpio_5/gpio_io_i] [get_bd_pins top_fpga_trenz_0/current_ia]
  connect_bd_net -net top_fpga_trenz_0_current_ib [get_bd_pins axi_gpio_5/gpio2_io_i] [get_bd_pins top_fpga_trenz_0/current_ib]
  connect_bd_net -net top_fpga_trenz_0_en_gate [get_bd_ports en_gate] [get_bd_pins top_fpga_trenz_0/en_gate]
  connect_bd_net -net top_fpga_trenz_0_i_out [get_bd_pins axi_gpio_4/gpio_io_i] [get_bd_pins top_fpga_trenz_0/i_out]
  connect_bd_net -net top_fpga_trenz_0_pwm_motor0 [get_bd_ports pwm_motor0] [get_bd_pins top_fpga_trenz_0/pwm_motor0]
  connect_bd_net -net top_fpga_trenz_0_pwm_motor1 [get_bd_ports pwm_motor1] [get_bd_pins top_fpga_trenz_0/pwm_motor1]
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"0.468002",
   "Default View_TopLeft":"-120,-154",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r4  2019-12-20 bk=1.5203 VDI=41 GEI=36 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 6 -x 2250 -y 100 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 6 -x 2250 -y 120 -defaultsOSRD
preplace port rst -pg 1 -lvl 0 -x -10 -y 400 -defaultsOSRD
preplace portBus CHB -pg 1 -lvl 0 -x -10 -y 630 -defaultsOSRD
preplace portBus CHA -pg 1 -lvl 0 -x -10 -y 610 -defaultsOSRD
preplace portBus CHI -pg 1 -lvl 0 -x -10 -y 590 -defaultsOSRD
preplace portBus MISO -pg 1 -lvl 0 -x -10 -y 570 -defaultsOSRD
preplace portBus pwm_motor0 -pg 1 -lvl 6 -x 2250 -y 140 -defaultsOSRD
preplace portBus pwm_motor1 -pg 1 -lvl 6 -x 2250 -y 160 -defaultsOSRD
preplace portBus en_gate -pg 1 -lvl 6 -x 2250 -y 180 -defaultsOSRD
preplace portBus MOSI -pg 1 -lvl 6 -x 2250 -y 200 -defaultsOSRD
preplace portBus SPI_clk -pg 1 -lvl 6 -x 2250 -y 220 -defaultsOSRD
preplace portBus CS -pg 1 -lvl 6 -x 2250 -y 240 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -x 270 -y 190 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 5 -x 1980 -y 470 -defaultsOSRD
preplace inst rst_ps7_0_100M -pg 1 -lvl 4 -x 1550 -y 280 -defaultsOSRD
preplace inst axi_gpio_0 -pg 1 -lvl 1 -x 270 -y 480 -defaultsOSRD
preplace inst axi_gpio_1 -pg 1 -lvl 1 -x 270 -y 710 -defaultsOSRD
preplace inst axi_gpio_2 -pg 1 -lvl 3 -x 1130 -y 790 -defaultsOSRD
preplace inst axi_gpio_3 -pg 1 -lvl 1 -x 270 -y 870 -defaultsOSRD
preplace inst axi_gpio_4 -pg 1 -lvl 2 -x 750 -y 890 -defaultsOSRD
preplace inst axi_gpio_5 -pg 1 -lvl 2 -x 750 -y 710 -defaultsOSRD
preplace inst axi_gpio_6 -pg 1 -lvl 4 -x 1550 -y 870 -defaultsOSRD
preplace inst top_fpga_trenz_0 -pg 1 -lvl 4 -x 1550 -y 580 -defaultsOSRD
preplace netloc processing_system7_0_FCLK_CLK0 1 0 5 20 970 510 580 960 580 1320 380 1810
preplace netloc processing_system7_0_FCLK_RESET0_N 1 1 3 490 260 N 260 N
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 0 5 50 620 560 600 940 640 1330 390 1780
preplace netloc axi_gpio_0_gpio_io_o 1 1 3 N 490 N 490 N
preplace netloc axi_gpio_1_gpio_io_o 1 1 3 530 550 N 550 1290
preplace netloc axi_gpio_1_gpio2_io_o 1 1 3 540 560 N 560 1300
preplace netloc axi_gpio_2_gpio_io_o 1 3 1 1310 570n
preplace netloc axi_gpio_2_gpio2_io_o 1 3 1 1340 590n
preplace netloc axi_gpio_3_gpio_io_o 1 1 3 550 590 970 610 NJ
preplace netloc axi_gpio_3_gpio2_io_o 1 1 3 570 620 930 630 NJ
preplace netloc top_fpga_trenz_0_i_out 1 2 3 920 930 1340J 960 1760
preplace netloc top_fpga_trenz_0_angle_out 1 2 3 900 940 1290J 970 1750
preplace netloc top_fpga_trenz_0_current_ia 1 2 3 NJ 700 1280J 770 1740
preplace netloc top_fpga_trenz_0_current_ib 1 2 3 930J 880 1350J 780 1730
preplace netloc axi_gpio_6_gpio_io_o 1 3 2 1370 790 1730
preplace netloc CHB_0_1 1 0 4 10J 560 520J 570 NJ 570 1300J
preplace netloc CHA_0_1 1 0 4 NJ 610 NJ 610 950J 620 1290J
preplace netloc CHI_0_1 1 0 4 NJ 590 480J 530 NJ 530 1280J
preplace netloc MISO_0_1 1 0 4 NJ 570 490J 540 NJ 540 1350J
preplace netloc rst_0_1 1 0 4 NJ 400 NJ 400 NJ 400 1350J
preplace netloc top_fpga_trenz_0_pwm_motor0 1 4 2 1760J 210 2210J
preplace netloc top_fpga_trenz_0_pwm_motor1 1 4 2 1750J 190 2220J
preplace netloc top_fpga_trenz_0_en_gate 1 4 2 1740J 130 2200J
preplace netloc top_fpga_trenz_0_MOSI 1 4 2 1790J 200 NJ
preplace netloc top_fpga_trenz_0_SPI_clk 1 4 2 1770J 220 NJ
preplace netloc top_fpga_trenz_0_CS 1 4 2 1800J 230 2210J
preplace netloc processing_system7_0_DDR 1 1 5 NJ 60 N 60 N 60 N 60 2220
preplace netloc processing_system7_0_FIXED_IO 1 1 5 NJ 80 N 80 N 80 N 80 2200
preplace netloc processing_system7_0_M_AXI_GP0 1 1 4 NJ 140 960 130 N 130 1730J
preplace netloc ps7_0_axi_periph_M00_AXI 1 0 6 30 380 480J 130 950 120 N 120 NJ 120 2190
preplace netloc ps7_0_axi_periph_M01_AXI 1 0 6 40 390 500J 150 970 140 N 140 NJ 140 2180
preplace netloc ps7_0_axi_periph_M02_AXI 1 2 4 980 150 NJ 150 NJ 150 2170
preplace netloc ps7_0_axi_periph_M03_AXI 1 0 6 60 960 580J 800 910 950 NJ 950 NJ 950 2130
preplace netloc ps7_0_axi_periph_M04_AXI 1 1 5 590 160 NJ 160 NJ 160 NJ 160 2160
preplace netloc ps7_0_axi_periph_M05_AXI 1 1 5 600 170 NJ 170 NJ 170 NJ 170 2150
preplace netloc ps7_0_axi_periph_M06_AXI 1 3 3 1360 180 NJ 180 2140
levelinfo -pg 1 -10 270 750 1130 1550 1980 2250
pagesize -pg 1 -db -bbox -sgen -130 0 2430 980
"
}
...
set_property IS_LOCKED "0" [get_files Block_design.bd ] 
...
if { [get_property IS_LOCKED [ get_files -norecurse Block_design.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../FOC-FPGA-HB.gen/sources_1/bd/Block_design/hdl/Block_design_wrapper.vhd" ]
} else {
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/FOC-FPGA-HB.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/FOC-FPGA-HB.srcs/utils_1/imports/impl_1" -objects $obj
